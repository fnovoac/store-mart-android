package com.shop_mart.services;
...
import static com.shop_mart.trackers.SettingsLocationTracker.ACTION_CURRENT_LOCATION_BROADCAST;
...
public class LocationService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private void sendPermissionDeniedBroadCast() {
        Intent locationIntent = new Intent();
        locationIntent.setAction(SettingsLocationTracker.ACTION_PERMISSION_DENIED);
        sendBroadcast(locationIntent);
    }
